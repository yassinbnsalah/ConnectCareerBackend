...
async function createInterview(req, res) {
  try {
    ...
    sendMailToStudent(user.email , user.firstname+user.lastname , dateInterview.split('T')[0]+" "+heure+":"+minutes , roomID , recruiterRealName.entreprise.CompanyName,
    job.jobTitle ) ; 
...
module.exports = {
  ...
  createInterview,
  getInterviewsByApplicationandUser,VerifyInterview
};
